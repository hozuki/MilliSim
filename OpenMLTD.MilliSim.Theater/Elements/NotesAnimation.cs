...
namespace OpenMLTD.MilliSim.Theater.Elements {
    public class NotesAnimation : BufferedElement2D {

        public NotesAnimation(GameBase game)
            : base(game) {
        }
        ...
        protected override void OnGotContext(RenderContext context) {
            ...
            if (settings.Images.Notes.Length == 0) {
                ...
                for (var i = 0; i < settings.Images.Notes.Length; ++i) {
                    ...
                    var imageStrip = Direct2DHelper.LoadImageStrip(notesImageEntry.File, context, notesImageEntry.Count, notesImageEntry.Orientation);
                    _noteImages[i] = imageStrip;
                }
            }

            Opacity = settings.UI.NotesAnimation.Opacity;
        }
