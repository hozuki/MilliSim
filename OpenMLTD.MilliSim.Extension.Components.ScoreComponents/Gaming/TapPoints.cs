...
namespace OpenMLTD.MilliSim.Extension.Components.ScoreComponents.Gaming {
    public class TapPoints : BufferedVisual2D {
        ...
        protected override void OnGotContext(RenderContext context) {
            ...
            var responder = Game.AsTheaterDays().FindSingleElement<MltdStageScalingResponder>();
            ...
            _tapPointImage = Direct2DHelper.LoadBitmap(context, config.Data.Images.TapPoint.FileName);

            var tapBarChainImage = Direct2DHelper.LoadBitmap(context, config.Data.Images.TapBarChain.FileName);
            _tapBarChainImage = tapBarChainImage;

            _tapBarNodeImage = Direct2DHelper.LoadBitmap(context, config.Data.Images.TapBarNode.FileName);
