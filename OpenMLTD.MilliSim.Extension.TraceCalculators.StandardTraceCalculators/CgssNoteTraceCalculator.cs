...
namespace OpenMLTD.MilliSim.Extension.TraceCalculators.StandardTraceCalculators {
    /// <inheritdoc cref="NoteTraceCalculator"/>
    /// <summary>
    /// This class calculates note traces in CGSS style.
    /// </summary>
    [MilliSimPlugin(typeof(INoteTraceCalculator))]
    [UsedImplicitly(ImplicitUseKindFlags.InstantiatedWithFixedConstructorSignature)]
    public sealed class CgssNoteTraceCalculator : NoteTraceCalculator {

        public override string PluginID => "plugin.trace_calculator.cgss";

        public override string PluginName => "CGSS Note Trace Calculator";
