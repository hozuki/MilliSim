...
namespace OpenMLTD.MilliSim.Graphics.Extensions {
    partial class RenderContextExtensions {
        ...
        public static void DrawBitmap(this RenderContext context, Bitmap bitmap, float opacity) {
            context.RenderTarget.DeviceContext2D.DrawBitmap(bitmap, opacity, BitmapInterpolationMode.Linear);
        }
        ...
        public static void DrawBitmap(this RenderContext context, Bitmap bitmap, float destX, float destY, float opacity) {
            ...
            context.RenderTarget.DeviceContext2D.DrawBitmap(bitmap, destRect, opacity, BitmapInterpolationMode.Linear);
        }
